...
COPY --from=compile /usr/src/mymaven/target/Rest_API-0.0.1-SNAPSHOT.jar app.jar
COPY src/main/resources/applicationDocker.properties application.properties
EXPOSE 8080
ENV JAVA_OPTS=""
